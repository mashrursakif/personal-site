		...
		<div className='max-w-full text-black pb-20'>
			<div className='mb-10'>
				...
				<p className='text-lg mb-4'>
					Creating a machine learning model to classify emails as spam based on
					given metadata
				</p>
...
predictor.fit(
   ...
   dynamic_stacking=True,
				...
				<p className='text-lg mt-6'>
					Full solution notebook can be found on my{' '}
					<Link
						className='text-lg underline text-blue-600 hover:text-blue-800'
						href='https://github.com/mashrursakif/machine-learning-comps/blob/main/spam_email_classification_solution.ipynb'
						target='_blank'
						rel='noopener noreferrer'
					>
						GitHub

	...
	return (
		<div className='max-w-full text-black pb-20'>
			...
			<div className='mb-8'>
				...
				<p className='text-lg mb-4'>
					This competition provided regional data on different types of diseases
					and number of outbreaks that had occurred each month. The data ranged
					from 2019 to 2022. And the model had to make predictions on outbreaks
					that could occur in 2023. The dataset also included information on
					water sources, waste management, and health facilities in the area,
					all of which were very useful for creating a good model. This was a
					regression task and the models were evaluated using Mean Absolute
					Error
				</p>
			</div>
...
full_train_data, full_test_data = target_encode_df(full_train_data, te_columns=['location', 'disease'], target_column='Total', test_df=full_test_data)`}
				...
				<p className='text-lg mb-4'>
					Full solution can be found on my{' '}
					<Link
						className='text-lg underline text-blue-600 hover:text-blue-800'
						href='https://github.com/mashrursakif/machine-learning-comps/blob/main/sea_outbreak_prediction_solution.ipynb'
						target='_blank'
						rel='noopener noreferrer'
					>
						GitHub
